...
export type GetCollaboratorsNamesQueryVariables = {
  name: Scalars['String'];
  owner: Scalars['String'];
};


export type GetCollaboratorsNamesQuery = (
  { __typename?: 'Query' }
  & { repository?: Maybe<(
    { __typename?: 'Repository' }
    & { collaborators?: Maybe<(
...
export const GetCollaboratorsNamesDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getCollaboratorsNames(variables: GetCollaboratorsNamesQueryVariables): Promise<GetCollaboratorsNamesQuery> {
      return withWrapper(() => client.request<GetCollaboratorsNamesQuery>(print(GetCollaboratorsNamesDocument), variables));
    }
  };
}
